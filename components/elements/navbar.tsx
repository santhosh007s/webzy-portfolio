...
const NavBar = () => {
  ...
  return (
//     <div className="nav w-full z-40 fixed top-12 flex items-center justify-center opacity-0 -translate-y-5 transition-all duration-500 boder border-blue-400">
//       <div
//       className="min-w-80 w-[85%] sm:w-[70%] xl:w-[28%] h-[67px] 
//   noise-pattern bg-repeat bg-blend-overlay backdrop-blur-3xl px-4 py-4 flex items-center 
...
className="min-w-80 w-[85%] sm:w-[70%] xl:w-[28%] h-[67px]
 noise-pattern bg-repeat bg-blend-overlay backdrop-blur-3xl px-4 py-4 flex items-center
justify-between rounded-2xl shadow-lg border border-[#4B8AEF]">
<div className="flex items-center justify-start w-1/4 pr-2 sm:pr-4">
<Image
src="/logo.png"
alt="logo"
