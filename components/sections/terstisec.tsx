...
const TestimonialsSection: React.FC = () => {
  ...
  const row3Testimonials: Testimonial[] = [
    {
      id: 7,
      stars: 3,
      text: "I recommended this app to all my friends and colleagues! It's the best calendar app out there, and it's made managing my schedule a breeze.",
      name: "Ella Mondain",
    ...
    },
    {
      id: 9,
      stars: 5,
      text: "I'm not the most organized person, but this app has made it easy for me to stay on top of things! I love how I can set reminders and get notifications, and it's really helped me.",
      name: "Johana Smith",
  ...
  const ScrollingRow: React.FC<ScrollingRowProps> = ({ testimonials, direction = "left", speed = 50 }) => {
    ...
    React.useEffect(() => {
      ...
      const animateRightLoop = async () => {
        ...
        if (!isCancelled) {
          requestAnimationFrame(() => animateRightLoop());
        }
      };
