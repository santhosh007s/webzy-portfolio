    ...
    <section className="relative bg-[#0e0e0e] text-white min-h-screen flex items-center justify-center px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl min-h-screen">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 flex items-center justify-center w-full translate-y-[-65px] sm:translate-y-[-80px] z-30">
          <div className="relative transform translate-y-[200px] sm:translate-y-[260px]"> {/* Change translate-y-[120px] to move this element up/down independently */}
            <div className="inline-block rounded-full bg-[#1a1a1a] px-2 py-[2px] text-xs sm:px-4 sm:py-1 sm:text-sm text-white border border-neutral-700">
              <span className="inline-block rounded-full bg-[#131316] px-[4px] py-[2px] mr-1 text-xs sm:px-2 sm:py-0 sm:mr-3 sm:text-sm">
                🔥
              </span>
        ...
        {/* Heading Container - INDEPENDENT POSITIONING */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 flex items-center justify-center w-full translate-y-[-32px] sm:translate-y-[-110px] z-20">
  <div className="relative transform sm:translate-y-[-120px] translate-y-[-160px]">
    {/* <h1 className="text-4xl md:text-7xl font-bold leading-tight w-full max-w-[100vw] sm:max-w-6xl text-center mx-auto px-4 sm:px-0">
        We Don’t Just Build Websites,We  <br /> <span className="text-blue-200"> Build Your Digital Legacy
            </span>
    </h1> */}
  ...
  <span className="block text-blue-200">
    Build Your Digital Legacy
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-full z-20">
          <div className="relative transform translate-y-[0px]"> {/* Change translate-y-[0px] to move this element up/down independently */}
            <div className="text-center flex flex-col items-center justify-center">
              <p className="text-gray-400 text-sm leading-relaxed  px-0 sm:hidden text-center mx-auto translate-y-[40px]">
                We craft stunning websites that don't just look good they build
                trust, drive results, and turn visitors into loyal clients.
              </p>
            ...
            <div className="hidden sm:block absolute left-70 top-[198px] transform -translate-y-1/2 -translate-x-20">
              <div className="relative transform translate-y-[0px] translate-x-[0px]"> {/* Change these values to move arrow independently */}
                <Arrow/>
              </div>
            </div>
          </div>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-full mt-8 z-20">
          <div className="relative transform translate-y-[100px] sm:translate-y-[130px]"> {/* Change translate-y-[120px] to move this element up/down independently */}
            <div className="flex items-center justify-center gap-4 flex-wrap">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 flex items-center justify-center w-full z-20">
          <div className="relative transform sm:translate-y-[-80px] translate-y-[-110px]"> {/* Change translate-y-[-50px] to move this element up/down independently */}
            <div className="w-full max-w-6xl flex items-center justify-center ">
              <SimpleServices />
            </div>
          </div>
