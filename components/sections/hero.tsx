...
// {/* Mobile heading */}
// <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 flex sm:hidden items-center justify-center w-full translate-y-[-50px] z-20">
...
//       {/* 2️⃣ Subtle Blue “Beam” — tweak left/top/width/height/bg/*blur* for flexibility */}
//       <div className="absolute z-0 left-[-25%] top-[-15%] w-[550px] h-[650px] bg-[#4b8aef33] blur-3xl rotate-[30deg] pointer-events-none" />

//       {/* 3️⃣ Black bottom fade */}
//       <div className="absolute inset-0 z-5 pointer-events-none bg-gradient-to-b from-transparent via-transparent to-black/100" />
...
//         {/* Badge */}
//         <div className="absolute top-0 left-1/2 -translate-x-1/2 flex w-full translate-y-[-65px] sm:translate-y-[-80px] z-30">
//           <div className="relative translate-y-[172px] sm:translate-y-[260px]">
//             <div className="inline-block rounded-full bg-[#1a1a1a] px-2 py-[2px] text-xs sm:px-4 sm:py-1 sm:text-sm text-white border border-neutral-700">
//               <span className="inline-block rounded-full bg-[#131316] px-[4px] py-[2px] mr-1 text-xs sm:px-2 sm:py-0 sm:mr-3 sm:text-sm">
//                 🔥
//               </span>
...
//         {/* Desktop Heading */}
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 sm:block hidden w-full translate-y-[-110px] z-20">
//           <div className="relative -translate-y-[120px]">
//             <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-tight text-center">
//               We Don't Just Build Websites,
//               <br />
//               <span className="text-blue-200">We Build Your Digital Legacy</span>
//             </h1>
//           </div>
//         </div>

//         {/* Mobile Heading */}
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 flex sm:hidden w-full translate-y-[-50px] z-20">
//           <div className="relative -translate-y-[190px] w-full">
...
//         {/* Description */}
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex w-full z-20">
//           <div className="relative">
//             <div className="text-center">
//               <p className="text-gray-400 text-sm leading-relaxed sm:hidden translate-y-[50px]">
//                 We craft stunning websites that don't just look good they build
//                 trust, drive results, and turn visitors into loyal clients.
//               </p>
//               <p className="text-gray-400 text-sm sm:text-xl hidden sm:block max-w-[50vw] mx-auto translate-y-[25px]">
//                 We craft stunning websites that don't just look good — they build
//                 trust, drive results, and turn visitors into loyal clients.
//                 Whether you're a startup or a brand ready to scale, we've got
//                 your digital back.
//               </p>
//             </div>

//             {/* Arrow */}
//             <div className="hidden sm:block absolute left-68 top-[198px] -translate-y-1/2 -translate-x-20">
//               <Arrow />
//             </div>
//           </div>
//         </div>
...
//         {/* Buttons */}
//         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full mt-8 z-20">
//           <div className="relative translate-y-[90px] sm:translate-y-[130px] flex justify-center gap-4 flex-wrap">
//             <Link href="https://cal.com/santhosh-perumal-qwqkgl/15min" passHref>
//               <button className="sm:px-6 sm:py-3 px-2 py-2 rounded-md bg-blue-600 hover:bg-blue-900 text-white font-medium transition">
//                 Let's build yours
//               </button>
//             </Link>
//             <button className="sm:px-6 sm:py-3 px-2 py-2 rounded-md bg-neutral-800 hover:bg-neutral-700 text-white font-medium transition">
//               Our works
//             </button>
//           </div>
//         </div>
...
//         {/* Trust Badge */}
//         <div className="relative sm:translate-y-[800px] translate-y-[570px] flex justify-center">
//           <h3 className="text-sm sm:text-lg">
//             Webzy is trusted by <span className="text-blue-300">10+ brands</span> worldwide
//           </h3>
//         </div>
...
//         {/* Services Animation */}
//         <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full z-20">
//           <div className="relative md:-translate-y-[80px] -translate-y-[110px]">
